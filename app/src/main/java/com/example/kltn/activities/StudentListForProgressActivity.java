...
public class StudentListForProgressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_students); // Tái sử dụng layout danh sách học viên
        ...
        if (btnAddStudent != null) btnAddStudent.setVisibility(View.GONE); // Ẩn nút add student
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(@NonNull View itemView) {
                ...
                itemView.setOnClickListener(v -> {
                    ...
                    Intent intent = new Intent(StudentListForProgressActivity.this, ProgressTrackingActivity.class);
